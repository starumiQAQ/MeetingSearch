...
**"周末去哪吃？"——一个每次都能吵起来的灵魂拷问。**

三个人约饭，两个人觉得还行，剩下的那个要横穿整座城。打开地图一家家比？太累了。掷骰子？迟早友尽。

**MeetingSearch 专治这种内耗。**

填上每个人的位置，告诉它你想去哪个品牌（比如滨寿司、海底捞），剩下的交给算法——

- 搜出附近所有分店
- 用**真实驾车距离**（不是直线，是实打实要踩油门的那种）算出每个人要开多远
- 按你定的规矩排好名次：「总路程最短」适合真爱，「最远的人尽量近」适合表面兄弟
- 结果摊开看：排名、具体路程、地图标记，谁也别喊冤

没高德密钥？没关系，内置演示数据直接起飞，零配置体验完整流程。有密钥？填进去立刻切真数据，不用重启，不用看进度条，填完即用。

> 一个本地网页，中文界面，Node.js 一把梭。不用注册、不装框架、不下 app，五分钟治好转谁请客的选择困难症。
...
- [chenmu](https://github.com/2756983619-collab)
